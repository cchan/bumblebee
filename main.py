...
def fixsize(name):
    try:
        os.remove(name+"_resized.mp4")
    except FileNotFoundError:
        pass
    moviepy.video.io.ffmpeg_tools.ffmpeg_resize(name+".mp4", name+"_resized.mp4", (W,H))
...
clive45 = VideoFileClip("clive45_resized"+POSTFIX+".mp4")
james45 = VideoFileClip("james45_resized"+POSTFIX+".mp4")
kat45 = VideoFileClip("kat45_resized"+POSTFIX+".mp4")
tony45 = VideoFileClip("tony45_resized"+POSTFIX+".mp4")
sara45 = VideoFileClip("sara45_resized"+POSTFIX+".mp4")
sara45nomargin = VideoFileClip("sara45nomargin_resized"+POSTFIX+".mp4")
...
clive0 = VideoFileClip("clive0_resized"+POSTFIX+".mp4")
james0 = VideoFileClip("james0"+POSTFIX+".mp4")
kat0 = VideoFileClip("kat0"+POSTFIX+".mp4")
tony0 = VideoFileClip("tony0_resized"+POSTFIX+".mp4")
sara0 = VideoFileClip("sara0"+POSTFIX+".mp4")
...
clivegrass = VideoFileClip("clivegrass"+POSTFIX+".mp4")
jamesgrass = VideoFileClip("jamesgrass"+POSTFIX+".mp4")
katgrass = VideoFileClip("katgrass"+POSTFIX+".mp4")
tonygrass = VideoFileClip("tonygrass_resized"+POSTFIX+".mp4")
saragrass = VideoFileClip("saragrass"+POSTFIX+".mp4")
...
out(concatenate_videoclips([
    ...
    columns([james45, clive45, tony0, sara45.flipX(), kat45.flipX()], widths=ws).subclip(1.5+4*M,1.5+5*M),
    columns([clive45, sara45, tony0, kat45.flipX(), james45.flipX()], widths=ws).subclip(1.5+5*M,1.5+6*M),
